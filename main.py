...
st.title("🍿What to watch?", anchor=False)
...
if movie_name:
    ...
    sub_header = st.subheader("Recommended Movies:", anchor = False)
    ...
    with status:
        ...
        for i, movie in enumerate(recommended_movies, start=1):
            ...
            try:
                ...
                movie["poster_url"] = "https://image.tmdb.org/t/p/w500/iiZZdoQBEYBv6id8su7ImL0oCbD.jpg"
                prev.warning("Failed to get movie poster for ***:orange[{}]***".format(
                    movie['title']), icon="⚠️")
            ...
            try:
                with cols[i-1]:
                    ...
                    sac.rate(label=None,
                             value=movie["rating"], half=True, readonly=True, count=10, key=movie["title"], color='#2980b9', size=10)
            except Exception as e:
                prev.error("Something went wrong while displaying movie details for ***:orange[{}]***".format(
